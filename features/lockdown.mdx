---
title: "Lockdown Mode"
description: "Cache-only scrape mode for compliance and air-gapped environments. No outbound traffic."
og:title: "Lockdown Mode | Firecrawl"
og:description: "Cache-only scrape mode for compliance and air-gapped environments. No outbound traffic."
---

import LockdownPython from "/snippets/v2/scrape/lockdown/python.mdx";
import LockdownNode from "/snippets/v2/scrape/lockdown/js.mdx";
import LockdownCURL from "/snippets/v2/scrape/lockdown/curl.mdx";
import LockdownCLI from "/snippets/v2/scrape/lockdown/cli.mdx";
