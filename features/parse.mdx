---
title: 'Parse'
description: 'Upload a local or non-public document and convert it into clean, LLM-ready data'
og:title: "Parse | Firecrawl"
og:description: "Turn local PDFs, DOCX, XLSX, HTML, and more into Markdown or structured JSON"
