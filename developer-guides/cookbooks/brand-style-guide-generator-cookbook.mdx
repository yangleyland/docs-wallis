---
title: "Building a Brand Style Guide Generator with Firecrawl"
description: "Generate professional PDF brand style guides by extracting design systems from any website using Firecrawl's branding format"
---
...
![Brand style guide PDF generator using Firecrawl branding format to extract design system](/images/guides/cookbooks/branding-format/brand-style-guide-pdf-generator-firecrawl.gif)
...
![Example of generated brand style guide PDF with colors typography and spacing](/images/guides/cookbooks/branding-format/generated-brand-style-guide-pdf-example.png)
...
![Side-by-side comparison of original website and generated brand style guide PDF](/images/guides/cookbooks/branding-format/website-to-brand-style-guide-comparison.png)
