...
Cet exemple illustre un flux de travail simple : scraper un site web et en résumer le contenu à l&#39;aide de Claude.
...
Cet exemple montre comment utiliser Claude pour extraire des données structurées à partir de contenu de sites web récupéré par scraping.
