...
description: Start and configure the open-source Firecrawl MCP server over stdio or Streamable HTTP.
sidebarTitle: Run MCP locally
---
...
<AccordionGroup>
  <Accordion title="The client reports spawn npx ENOENT">
  ...
  <Accordion title="The HTTP client cannot connect">
  ...
  <Accordion title="A tool is unavailable">
  ...
  <Accordion title="The server is rate-limited">
