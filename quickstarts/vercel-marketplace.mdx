...
description: "Install Firecrawl from the Vercel Marketplace, attach it to a project, and use the injected FIRECRAWL_API_KEY in your Vercel app."
og:title: "Vercel Marketplace Integration | Firecrawl"
og:description: "Install Firecrawl from the Vercel Marketplace, attach it to a project, and use the injected FIRECRAWL_API_KEY in your Vercel app."
---
...
<CardGroup cols={2}>
  <Card title="Vercel Functions quickstart" icon="bolt" href="/quickstarts/vercel-functions">
    Use Firecrawl in Vercel Functions with manual environment setup
  </Card>
  <Card title="Vercel AI SDK guide" icon="puzzle-piece" href="/developer-guides/llm-sdks-and-frameworks/vercel-ai-sdk">
