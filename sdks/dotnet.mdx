---
title: '.NET'
description: 'Firecrawl .NET SDK is a wrapper around the Firecrawl API to help you easily turn websites into markdown.'
icon: 'microsoft'
og:title: ".NET SDK | Firecrawl"
og:description: "Firecrawl .NET SDK is a wrapper around the Firecrawl API to help you easily turn websites into markdown."
---
...
<Note>Requires .NET 8.0 or later.</Note>
