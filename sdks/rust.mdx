---
title: 'Rust'
description: 'Firecrawl Rust SDK is a wrapper around the Firecrawl API to help you easily turn websites into markdown.'
icon: 'rust'
og:title: "Rust SDK | Firecrawl"
og:description: "Firecrawl Rust SDK is a wrapper around the Firecrawl API to help you easily turn websites into markdown."
---
...
<Note>Requires Rust 1.70 or later.</Note>
