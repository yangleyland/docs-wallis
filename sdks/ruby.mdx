---
title: 'Ruby'
description: 'Firecrawl Ruby SDK is a wrapper around the Firecrawl API to help you easily turn websites into markdown.'
icon: 'gem'
og:title: "Ruby SDK | Firecrawl"
og:description: "Firecrawl Ruby SDK is a wrapper around the Firecrawl API to help you easily turn websites into markdown."
---
...
<Note>Requires Ruby 3.0 or later.</Note>
